...
Route::group(['prefix' => 'catastrocbba/misc/', 'namespace' => 'App\Modules\Catastrocbba\Controllers'], function (){
    ...
    Route::get('migrarImagenes','PredioController@migrarImagenes2');
...
Route::group(['prefix' => 'catastrocbba/api/v1', 'namespace' => 'App\Modules\Catastrocbba\Controllers'], function (){    
		...
		Route::post('migrarDatos', 'UserController@migrarDatosByIdUsuarioAndIdPredio');
        ...
        Route::get('getDataMigracion/{idPredio}', 'MigracionController@showByIdPredio');
