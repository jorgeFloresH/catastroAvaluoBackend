...
class ImagenPredioController extends Controller
{
    ...
    public function getListImagenPredioByIdPredioIdTipoRelacion($idPredio,$tipoRelacion){
        return ImagenPredio::where([['idPredio', '=', $idPredio],['tipoRelacion','=',$tipoRelacion]])->get();
    }

    //agregado Ruddy
    public static function getListImagenPredioByIdPredio($idPredio){
        return ImagenPredio::where([['idPredio', '=', $idPredio]])->get();
    }
    ...
    public function getCroquisByIdPredio($idPredio){
        return ImagenPredio::where([['idPredio','=',$idPredio],['tipoRelacion','=',ImagenPredioController::$TIPO_CROQUIS]])->first();
    }
    public function getURLCroquisByIdPredio($idPredio){
        ...
        else return "http://".$_SERVER["HTTP_HOST"]."/catastroBackend/public/imagenes/".$imagenPredio->imagen;
    }
    public function getUbicacionByIdPredio($idPredio){
        return ImagenPredio::where([['idPredio','=',$idPredio],['tipoRelacion','=',ImagenPredioController::$TIPO_UBICACION]])->first();
    }
    ...
    public function getListaFachadaByIdPredio($idPredio){
        return ImagenPredio::where([['idPredio','=',$idPredio],['tipoRelacion','=',ImagenPredioController::$TIPO_FACHADA]])->get();
    }
    public function getOtrosByIdPredio($idPredio){
        return ImagenPredio::where([['idPredio','=',$idPredio],['tipoRelacion','=',ImagenPredioController::$TIPO_OTROS]])->first();
    }
