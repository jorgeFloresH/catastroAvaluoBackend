...
class UserController extends Controller
{
    ...
    public function store(Request $request) {
        ...
        if($usuario->save()){
            ...
            $url="http://catastrocbba.com/catastroBackend/public/catastrocbba/misc/validacion?code=$codigoValidacion&email=".$usuario->email;
    ...
    public function migrarDatosByIdUsuarioAndIdPredio(Request $request)
    {
            ...
            //modificamos el estado del avaluo original y el avaluo2 migrado a 1 para señalar que fue migrado
            try {
                ...
                if(isset($partes[1])){
                    ...
                    if($usuario!=null){
                        if($usuario->email==$email){
                            ...
                            if($usuario->save())
                                return Response::json(array('success' => true, 'mensaje' => "OK"), 200);
                            else return Response::json(array('success' => false, 'mensaje' => "No se pudo activar la cuenta."), 200);
                        }    
                    }
