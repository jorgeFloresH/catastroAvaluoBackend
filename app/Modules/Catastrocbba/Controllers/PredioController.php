...
class PredioController extends Controller
{
    ...
    //agregado Ruddy2
    public function migrarImagenes2()
    {
        //$input = $request->all();
        $lista1 = array();
        $lista2 = array();
        ...
        $directorio = opendir(storage_path().'/uploads/'); //ruta actual
            while ($archivo = readdir($directorio)) //obtenemos un archivo y luego otro sucesivamente
            {
                ...
                {
                    array_push($lista2, $archivo);
                }
            }

            $listaImagenesDB = DB::table('imagen_predio as i')
                ->select('i.*')
                ->where([['i.estado', 'like', 'AC']])
                ->get();

            foreach ($listaImagenesDB as $value) {
                array_push($lista1, $value->imagen);
            }
        ...
        try {
             ...
             for ($i=0; $i < count($lista1); $i++) {
                ...
                if (!in_array($var, $lista2)) {
                    array_push($lista3,$var);
                }
            
              }
              foreach ($lista3 as $k) {
                  //ruta de las imagenes en el servidor www.catastro.com
                $target_path_server = "http://www.catastrocbba.com/catastroBackend/storage/uploads/".$k;

                //ruta del servidor local al que se copiaran las imagenes
                 $target_path_local = storage_path().'/uploads/'.$k;
		...
		return Response::json($lista3,200);
    }
    ...
    public static function getListPredioByIdUsuarioAndCodCatastral(Request $request){
        ...
        if ($tipoUsuario == 0) {
            ...
            ->join('avaluo as a', 'a.idAvaluo', '=', 'p.idAvaluo')
            ->select('p.*', 'a.fechaRegistro', 'a.numeroFormulario', 'dp.apellidoUno', 'dp.apellidoDos','dp.nombres','dp.denominacion')
            ->where([['a.idUsuario', '=', $idUsuarioJson],['a.estado','like','AC'], ['p.codigoCatastral','like',$codigoCatastralJson.'%']])
            ->get();
            return $listaPredios;
        }
        if ($tipoUsuario == 1 || $tipoUsuario == 2) {
            ...
            ->join('avaluo as a', 'a.idAvaluo', '=', 'p.idAvaluo')
            ->select('p.*', 'a.fechaRegistro', 'a.numeroFormulario', 'dp.apellidoUno', 'dp.apellidoDos','dp.nombres','dp.denominacion')
            ->where([['a.estado','like','AC'], ['p.codigoCatastral','like',$codigoCatastralJson.'%']])
            ->get();
            return $listaPredios;
        }
    ...
    public static function getListPredioByIdUsuarioAndNroFormulario(Request $request){
        ...
        if ($tipoUsuario == 0) {
            ...
            ->join('avaluo as a', 'a.idAvaluo', '=', 'p.idAvaluo')
            ->select('p.*', 'a.fechaRegistro', 'a.numeroFormulario', 'dp.apellidoUno', 'dp.apellidoDos','dp.nombres','dp.denominacion')
            ->where([['a.idUsuario', '=', $idUsuarioJson],['a.estado','like','AC'], ['a.numeroFormulario','=',$numeroFormularioJson]])
            ->get();
            return $listaPredios;
        }
        if ($tipoUsuario == 1 || $tipoUsuario == 2) {
            ...
            ->join('avaluo as a', 'a.idAvaluo', '=', 'p.idAvaluo')
            ->select('p.*', 'a.fechaRegistro', 'a.numeroFormulario', 'dp.apellidoUno', 'dp.apellidoDos','dp.nombres','dp.denominacion')
            ->where([['a.estado','like','AC'], ['a.numeroFormulario','=',$numeroFormularioJson]])
            ->get();
            return $listaPredios;
        }
    }
    public static function getListPredioByIdUsuarioAndApellido(Request $request){
        ...
        if ($tipoUsuario == 0) {
            ...
            ->join('avaluo as a', 'a.idAvaluo', '=', 'p.idAvaluo')
            ->select('p.*', 'a.fechaRegistro', 'a.numeroFormulario', 'dp.apellidoUno', 'dp.apellidoDos','dp.nombres','dp.denominacion')
            ->where([['a.idUsuario', '=', $idUsuarioJson],['a.estado','like','AC'], ['dp.apellidoUno','like',$apellidoUnoJson.'%']])
            ->orwhere([['a.idUsuario', '=', $idUsuarioJson],['a.estado','like','AC'], ['dp.denominacion', 'like', $apellidoUnoJson .'%']])
            ->get();
            return $listaPredios;
        }
        if ($tipoUsuario == 1 || $tipoUsuario == 2) {
            ...
            ->join('avaluo as a', 'a.idAvaluo', '=', 'p.idAvaluo')
            ->select('p.*', 'a.fechaRegistro', 'a.numeroFormulario', 'dp.apellidoUno', 'dp.apellidoDos','dp.nombres','dp.denominacion')
            ->where([['a.estado','like','AC'], ['dp.apellidoUno','like',$apellidoUnoJson.'%']])
            ->orwhere([['a.estado','like','AC'], ['dp.denominacion', 'like', $apellidoUnoJson .'%']])
            ->get();
            return $listaPredios;
        }
    ...
    public static function getListPredioByIdUsuarioAndNumeroInmuebleAndTipoUsuario(Request $request)
    {
        ...
        {    
           $listaPredios = DB::table('predio as p')
            ...
            ->join('avaluo as a', 'a.idAvaluo', '=', 'p.idAvaluo')
            ->select('p.*', 'a.fechaRegistro', 'a.numeroFormulario', 'dp.apellidoUno', 'dp.apellidoDos','dp.nombres','dp.denominacion')
            ->where([['a.idUsuario', '=', $idUsuarioJson], ['p.numeroInmueble','=',$numeroInmueble],['a.estado','like','AC']])
            ->get();
        }
        if($tipoUsuario == 1 || $tipoUsuario == 2)
        {
            ...
            ->join('avaluo as a', 'a.idAvaluo', '=', 'p.idAvaluo')
            ->select('p.*', 'a.fechaRegistro', 'a.numeroFormulario', 'dp.apellidoUno', 'dp.apellidoDos','dp.nombres','dp.denominacion')
            ->where([['p.numeroInmueble','=',$numeroInmueble],['a.estado','like','AC']])
            ->get();
        }
    ...
    public static function getListPrediobyIdUsuarioAndNombreAndApellidoAndTipoUsuario(Request $request)
    {
        ...
        if($tipoUsuario == 0)
        {
            ...
            if ($apellidoUnoJson == null && $nombresJson != null) {
                ...
                ->join('avaluo as a', 'a.idAvaluo', '=', 'p.idAvaluo')
                ->select('p.*', 'a.fechaRegistro', 'a.numeroFormulario', 'dp.apellidoUno', 'dp.apellidoDos','dp.nombres','dp.denominacion')
                ->where([['a.idUsuario', '=', $idUsuarioJson],['a.estado','like','AC'],['dp.nombres','like',$nombresJson.'%']])
                ->orwhere([['a.idUsuario', '=', $idUsuarioJson],['a.estado','like','AC'], ['dp.denominacion', 'like', $nombresJson .'%']])
                ->get();
                return $listaPredios;
            }
            if($nombresJson == null && $apellidoUnoJson == null)
        ...
        if($tipoUsuario == 1 || $tipoUsuario == 2)
        {
            ...
            if ($apellidoUnoJson == null && $nombresJson != null) {
                ...
                ->join('avaluo as a', 'a.idAvaluo', '=', 'p.idAvaluo')
                ->select('p.*', 'a.fechaRegistro', 'a.numeroFormulario', 'dp.apellidoUno', 'dp.apellidoDos','dp.nombres','dp.denominacion')
                ->where([['a.estado','like','AC'],['dp.nombres','like',$nombresJson.'%']])
                ->orwhere([['a.estado','like','AC'], ['dp.denominacion', 'like', $nombresJson .'%']])
                ->get();
                return $listaPredios;
            }
            if($nombresJson == null && $apellidoUnoJson == null)
