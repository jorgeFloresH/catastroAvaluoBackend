...
class PdfController extends Controller
{
    ...
    private function getMatriz($idPredio){
        ...
        foreach ($listaBloques as $bloqueDato){
            ...
            }else $observacionesGenerales.="; ".$bloqueDato->numerobloque.":".(strlen(trim($bloqueDato->observaciones))>0?$bloqueDato->observaciones:"No se realizo comentarios");
        }
        foreach ($listaMejoras as $bloqueDato){
            ...
            }else $observacionesGenerales.="; ".$bloqueDato->tipoMejora.":".(strlen(trim($bloqueDato->observaciones))>0?$bloqueDato->observaciones:"No se realizo comentarios");
        }
    ...
    private function generarQRCode($numeroFormulario,$fechaImpresion,$profesional){
